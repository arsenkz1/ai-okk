...
// Ежедневный отчёт всем администраторам в 09:00 (Asia/Almaty): звонки,
// поступления, план и переводы в Феникс. Вместе с уведомлением о переезде
// сделки в Феникс это единственное, что получают остальные администраторы.
cron.schedule(
  "0 9 * * *",
  async () => {
